...
/**
 * Requirement 9 (after): 2000 concurrent users with the same protected checkout path.
 * This is a heavier staged run intended for the upper bound of the stress plan.
 * Preparation: php artisan db:seed --class=SimulationSeeder
 * Run: k6 run req9_stress_2000_users.js
 */
...
export function handleSummary(data) {
  return summary(data, 'REQ9 STRESS AFTER (2000 users, protected)');
}
